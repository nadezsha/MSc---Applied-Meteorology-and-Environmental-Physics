...
BASE = Path(r"C:\MSc - Applied Meteorology and Environmental Physics\MSc Thesis\AERONET\epanomi")
DATA_DIR = BASE / r"GHI\AERONET_data\all_data"

AOD_FILE = DATA_DIR / r"20250422_20250520_Thessaloniki.aod"  # EXTINCTION
ASY_FILE = DATA_DIR / r"20250422_20250520_Thessaloniki.asy"  # ASYMMETRY  <-- set to your .asy filename
TAB_FILE = DATA_DIR / r"20250422_20250520_Thessaloniki.tab"  # ABSORPTION

DETAIL_CSV = Path(r"C:\MSc - Applied Meteorology and Environmental Physics\MSc Thesis\AERONET\epanomi\DNI\outputs\aeronet_alpha_beta_pwv_detail.csv")
...
DATE_START = pd.Timestamp("2025-04-22")
DATE_END   = pd.Timestamp("2025-05-21")  # exclusive -> up to 20/05
