...
# Long-format CSV produced by the Epanomi GHI ratio script
INPUT_CSV = SCRIPT_DIR / "epanomi_spectral_meas_model_long.csv"

# Where to save the figures
OUTPUT_DIR = SCRIPT_DIR / "spectral_daily_hourly_ratio_plots"

DATETIME_COL = "Datetime"
WVL_COL = "wavelength_nm"

# Column names from epanomi_spectral_meas_model_long.csv
...
for (the_date, the_hour), df_hour in grouped:
    ...
    plt.title(f"Epanomi spectral GHI ratios - {the_date} - hour {the_hour:02d}")
