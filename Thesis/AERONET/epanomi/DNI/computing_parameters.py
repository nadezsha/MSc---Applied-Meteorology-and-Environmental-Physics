...
# ------------------ CONFIG ------------------
AOD_DIR = Path(r"C:\MSc - Applied Meteorology and Environmental Physics\MSc Thesis\AERONET\epanomi\DNI\AERONET_AOD_water_vapour_data\all_data")
PWV_DIR = Path(r"C:\MSc - Applied Meteorology and Environmental Physics\MSc Thesis\AERONET\epanomi\DNI\AERONET_AOD_water_vapour_data\all_data")

# Where to save ALL outputs (will be created if missing)
OUT_DIR = Path(r"C:\MSc - Applied Meteorology and Environmental Physics\MSc Thesis\AERONET\epanomi\DNI\outputs")
