"""
uvspec input generator from AERONET daily medians (Epanomi)
----------------------------------------------------------
...
- Inside: epanomi_<date>_sza_<XXXpX>.inp for SZAs 15.0..90.0 every 0.5 deg.
...
# Base project folder
BASE_DIR = Path(r"C:\MSc - Applied Meteorology and Environmental Physics\MSc Thesis\AERONET\epanomi\DNI")
...
BASE = """# file for Epanomi
atmosphere_file /home/nadezsha/libRadtran-2.0.6/data/atmmod/afglms.dat
...
for _, row in df.iterrows():
    ...
    for sza in sza_vals:
        ...
        fname = daydir / f"epanomi_{date_str}_sza_{sza_tag(sza)}.inp"
