...
FILE = r"C:\MSc - Applied Meteorology and Environmental Physics\MSc Thesis\libradtran_only_molecular\helmos_model\integrated_data\integrated_irradiance_by_sza.csv"
...
plt.title("Irradiances corrected for Earth–Sun distance (Helmos AERONET)")
plt.legend()
plt.grid()
plt.tight_layout()
plt.savefig(figures_dir / "helmos_corrected_irradiances.png", dpi=300)
plt.show()
...
plt.xlabel("Solar Zenith Angle (deg)" if col_sza else "Index")
plt.ylabel("Irradiance (W/m²)")
plt.title("DNI corrected for Earth–Sun distance (Helmos AERONET)")
plt.grid()
plt.tight_layout()
plt.savefig(figures_dir / "helmos_corrected_DNI_irradiance.png", dpi=300)
plt.show()
...
plt.xlabel("Solar Zenith Angle (deg)" if col_sza else "Index")
plt.ylabel("Irradiance (W/m²)")
plt.title("DHI corrected for Earth–Sun distance (Helmos AERONET)")
plt.grid()
plt.tight_layout()
plt.savefig(figures_dir / "helmos_corrected_DHI_irradiance.png", dpi=300)
plt.show()